...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::feassemble::AuxiliaryFactory::AuxiliaryFactory(void) : _queryDB(NULL),
                                                               _fieldQuery(NULL)
{
...
void pylith::feassemble::AuxiliaryFactory::setQueryDB(spatialdata::spatialdb::SpatialDB *value)
{
    _queryDB = value;
} // setQueryDB
...
void pylith::feassemble::AuxiliaryFactory::initialize(pylith::topology::Field *field,
                                                      ...
                                                      const pylith::topology::FieldBase::Description *defaultDescription)
{
    ...
    delete _fieldQuery;
    _fieldQuery = new pylith::topology::FieldQuery(*field);
...
void pylith::feassemble::AuxiliaryFactory::setValuesFromDB(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::feassemble::AuxiliaryFactory::setSubfieldQuery(const char *subfieldName,
