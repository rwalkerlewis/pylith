...
// ----------------------------------------------------------------------
// Constructor
pylith::problems::InitialConditionDomain::InitialConditionDomain(void) : _db(NULL)
{
...
void pylith::problems::InitialConditionDomain::deallocate(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::problems::InitialConditionDomain::setDB(spatialdata::spatialdb::SpatialDB *db)
{
    PYLITH_METHOD_BEGIN;
...
// ---------------------------------------------------------------------------------------------------------------------
// Set solver type.
void pylith::problems::InitialConditionDomain::setValues(pylith::topology::Field *solution,
