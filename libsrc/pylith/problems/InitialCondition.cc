...
void pylith::problems::InitialCondition::deallocate(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::problems::InitialCondition::setSubfields(const char *subfields[],
...
void pylith::problems::InitialCondition::verifyConfiguration(const pylith::topology::Field &solution) const
{
    PYLITH_METHOD_BEGIN;
