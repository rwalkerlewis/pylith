...
/** @file libsrc/fekernels/IsotropicLinearPoroelasticityBlackOil.hh
 *
 * Kernels for linear poroelasticityblackoil plane strain.
 *
...
#if !defined(pylith_fekernels_isotropiclinearporoelasticityblackoil_hh)
#define pylith_fekernels_isotropiclinearporoelasticityblackoil_hh
...
// ---------------------------------------------------------------------------------------------------------------------
/// Kernels specific to isotropic, linearl poroelasticityblackoil in Plane Strain.
class pylith::fekernels::IsotropicLinearPoroelasticityBlackOilPlaneStrain {
    // PUBLIC MEMBERS ///////////////////////////////////////////////////////
public:
    ...
    // ----------------------------------------------------------------------
    // f0u function for generic poroelasticityblackoil terms.
    static
    void f0u_implicit(const PylithInt dim,
    ...
    // f0u function for generic poroelasticityblackoil terms.
    static
    void f0u_body_implicit(const PylithInt dim,
                      const PylithInt numS,
                      const PylithInt numA,
                      const PylithInt sOff[],
                      const PylithInt sOff_x[],
    ...
    // f0u function for generic poroelasticityblackoil terms.
    static
    void f0u_grav_implicit(const PylithInt dim,
                      const PylithInt numS,
                      const PylithInt numA,
                      const PylithInt sOff[],
                      const PylithInt sOff_x[],
    ...
    // f0u function for generic poroelasticityblackoil terms.
    static
    void f0u_body_grav_implicit(const PylithInt dim,
                      const PylithInt numS,
                      const PylithInt numA,
                      const PylithInt sOff[],
                      const PylithInt sOff_x[],
    ...
    // ----------------------------------------------------------------------
    // f0p function for generic poroelasticityblackoil terms (source density).
    static
    ...
    // -----------------------------------------------------------------------------
    /** f1u function for isotropic linear poroelasticityblackoil plane strain WITH reference stress and reference strain.
     *
    ...
    // ----------------------------------------------------------------------
    /* Jf3_uu entry function for isotropic linear poroelasticityblackoil.
     */
    static
    ...
    // ----------------------------------------------------------------------
    /** Jf2_up entry function for isotropic linear poroelasticityblackoil.
     * Solution fields: [...]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), other poroelastic related param ...]
     */
    static
    ...
    // -----------------------------------------------------------------------------
    // Jf2ue function for isotropic linear poroelasticityblackoil.
    static
    ...
    // ----------------------------------------------------------------------
    /** Jf3pp entry function for isotropic linear poroelasticityblackoil.
     *
     * Solution fields: [...]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), other poroelastic related param ...]
     */
    ...
    // ----------------------------------------------------------------------
    /** Jf0_pp entry function for isotropic linear poroelasticityblackoil.
     *
     * Solution fields: [...]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), other poroelastic related param ...]
     */
    ...
    // ----------------------------------------------------------------------
    /** Jf0_pe entry function for isotropic linear poroelasticityblackoil.
     *
     * Solution fields: [...]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), other poroelastic related param ...]
     */
    ...
    // ----------------------------------------------------------------------
    /** Jf0_ppdot entry function for isotropic linear poroelasticityblackoil.
     *
     * Solution fields: [...]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), other poroelastic related param ...]
     */
    ...
    // ----------------------------------------------------------------------
    /** Jf0_pedot entry function for isotropic linear poroelasticityblackoil.
     *
     * Solution fields: [...]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), other poroelastic related param ...]
     */
    ...
    // ----------------------------------------------------------------------
    // g0p function for generic poroelasticityblackoil terms.
    ...
    // \frac{\partial \epsilon)_{v}}{\partial t} = \frac{\nabla \cdot \vec{u}}{dt}
    static
    void g0v_gravity(const PylithInt dim,
             const PylithInt numS,
             const PylithInt numA,
             const PylithInt sOff[],
             const PylithInt sOff_x[],
    ...
    // \frac{\partial \epsilon)_{v}}{\partial t} = \frac{\nabla \cdot \vec{u}}{dt}
    static
    void g0v_gravity_bodyforce(const PylithInt dim,
             const PylithInt numS,
             const PylithInt numA,
             const PylithInt sOff[],
             const PylithInt sOff_x[],
    ...
    // -----------------------------------------------------------------------------
    /** g1v function for isotropic linear poroelasticityblackoil plane strain WITHOUT reference stress and reference strain.
     * Dynamic Case
     * Solution fields: [disp(dim), pore_pres(dim), vel(dim, optional)]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), ...]
     */
    ...
    // -----------------------------------------------------------------------------
    /** g1v function for isotropic linear poroelasticityblackoil plane strain WITH reference stress and reference strain.
     *
     * Solution fields: [disp(dim), pres(dim), vel(dim, optional)]
     * Auxiliary fields: [density(1), shear_modulus(1), bulk_modulus(1), ..., refstress(4), refstrain(4)]
     */
    ...
    */
    static
    void porosity(const PylithInt dim,
                               const PylithInt numS,
                               const PylithInt numA,
                               const PylithInt sOff[],
                               const PylithInt sOff_x[],
     ...
     */
    static
    void updatePorosityNone(const PylithInt dim,
                        const PylithInt numS,
                        const PylithInt numA,
                        const PylithInt sOff[],
                        const PylithInt sOff_x[],
...
}; // IsotropicLinearPoroelasticityBlackOilPlaneStrain

// ---------------------------------------------------------------------------------------------------------------------
/// Kernels specific to isotropic, linearl poroelasticityblackoil in 3D.
class pylith::fekernels::IsotropicLinearPoroelasticityBlackOil3D {
    // PUBLIC MEMBERS ///////////////////////////////////////////////////////
public:
...
#endif // pylith_fekernels_isotropiclinearporoelasticityblackoil_hh

}; // IsotropicLinearPoroelasticityBlackOil3D
