...
public:
     ...
     *  f0p_f = porosity * (\beta^p * (\dot{p}^+ + 2 \dot{p}^f + \dot{p}^-)/4
     ...
     *  Solution fields: [disp(dim), vel(dim), ..., lagrange(dim), fault_pressure(1)]
     */
    static void f0p_f(const PylithInt dim,
                      const PylithInt numS,
                      const PylithInt numA,
                      const PylithInt sOff[],
                      const PylithInt sOff_x[],
     ...
     *  Solution fields: [disp(dim), vel(dim), ..., lagrange(dim), fault_pressure(1)]
     */
    static void f0p_f_body(const PylithInt dim,
                           const PylithInt numS,
                           const PylithInt numA,
                           const PylithInt sOff[],
                           const PylithInt sOff_x[],
     ...
     *  Solution fields: [disp(dim), vel(dim), ..., lagrange(dim), fault_pressure(1)]
     */
    static void f0p_f_source(const PylithInt dim,
                             const PylithInt numS,
                             const PylithInt numA,
                             const PylithInt sOff[],
                             const PylithInt sOff_x[],
     ...
     *  Solution fields: [disp(dim), vel(dim), ..., lagrange(dim), fault_pressure(1)]
     */
    static void f0p_f_body_source(const PylithInt dim,
                                  const PylithInt numS,
                                  const PylithInt numA,
                                  const PylithInt sOff[],
                                  const PylithInt sOff_x[],
     ...
     *  Solution fields: [disp(dim), vel(dim), ..., lagrange(dim), fault_pressure(1)]
     */
    static void f1p_f(const PylithInt dim,
                      const PylithInt numS,
                      const PylithInt numA,
                      const PylithInt sOff[],
                      const PylithInt sOff_x[],
