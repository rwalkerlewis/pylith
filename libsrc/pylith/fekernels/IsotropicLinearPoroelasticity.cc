...
// ----------------------------------------------------------------------
// f0u function for poroelastic fault MMS test one.
void pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0_poro_test_one_u(const PylithInt dim,
                                                                                     const PylithInt numS,
                                                                                     const PylithInt numA,
                                                                                     const PylithInt sOff[],
                                                                                     const PylithInt sOff_x[],
...
// ----------------------------------------------------------------------
// f0u function for poroelastic fault MMS test one.
void pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0_poro_test_one_p(const PylithInt dim,
                                                                                     const PylithInt numS,
                                                                                     const PylithInt numA,
                                                                                     const PylithInt sOff[],
                                                                                     const PylithInt sOff_x[],
