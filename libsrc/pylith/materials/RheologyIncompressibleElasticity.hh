...
public:
     ...
     */
    virtual PetscPointFunc getKernelResidualStress(const spatialdata::geocoords::CoordSys *coordsys) const = 0;
     ...
     */
    virtual PetscPointFunc getKernelResidualPressure(const spatialdata::geocoords::CoordSys *coordsys) const = 0;
     ...
     */
    virtual PetscPointJac getKernelJacobianElasticConstants(const spatialdata::geocoords::CoordSys *coordsys) const = 0;
     ...
     */
    virtual PetscPointJac getKernelJacobianInverseBulkModulus(const spatialdata::geocoords::CoordSys *coordsys) const = 0;
