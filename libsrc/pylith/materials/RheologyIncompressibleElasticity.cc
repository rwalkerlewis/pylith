...
void pylith::materials::RheologyIncompressibleElasticity::deallocate(void) {}

// ---------------------------------------------------------------------------------------------------------------------
// Update kernel constants.
void pylith::materials::RheologyIncompressibleElasticity::updateKernelConstants(pylith::real_array *kernelConstants,
...
void pylith::materials::RheologyIncompressibleElasticity::addKernelsUpdateStateVars(std::vector<pylith::feassemble::IntegratorDomain::ProjectKernels> *kernels,
