...
/** @file libsrc/materials/MultiphasePoroelasticity.hh
 *
 * @brief C++ class for solving multiphase poroelasticity equation.
 */

#if !defined(pylith_materials_multiphaseporoelasticity_hh)
#define pylith_materials_multiphaseporoelasticity_hh

#include "materialsfwd.hh" // forward declarations

#include "pylith/materials/Material.hh" // ISA Material

class pylith::materials::MultiphasePoroelasticity : public pylith::materials::Material {
    friend class TestMultiphasePoroelasticity; // unit testing

    // PUBLIC METHODS //////////////////////////////////////////////////////////////////////////////////////////////////
public:

    /// Default constructor.
    MultiphasePoroelasticity(void);
     ...
     */
    void setBulkRheology(pylith::materials::RheologyMultiphasePoroelasticity* const rheology);

    /** Get bulk rheology.
     *
     * @returns Bulk rheology for elasticity.
     */
    pylith::materials::RheologyMultiphasePoroelasticity* getBulkRheology(void) const;
...
private:
    ...
    pylith::materials::RheologyMultiphasePoroelasticity* _rheology; ///< Bulk rheology for elasticity.
    pylith::materials::DerivedFactoryElasticity* _derivedFactory; ///< Factory for creating derived fields.

    // NOT IMPLEMENTED /////////////////////////////////////////////////////////////////////////////////////////////////
private:

    MultiphasePoroelasticity(const MultiphasePoroelasticity&); ///< Not implemented.
    const MultiphasePoroelasticity& operator=(const MultiphasePoroelasticity&); /// Not implemented.

}; // class MultiphasePoroelasticity

#endif // pylith_materials_multiphaseporoelasticity_hh
