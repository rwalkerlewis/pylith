...
#include "pylith/materials/AnisotropicLinearPoroelasticity.hh" // implementation of object methods
#include "pylith/materials/AuxiliaryFactoryPoroelastic.hh" // USES AuxiliaryFactory

#include "pylith/fekernels/AnisotropicLinearPoroelasticity.hh" // USES IsotropicLinearIncompElasticity kernels
