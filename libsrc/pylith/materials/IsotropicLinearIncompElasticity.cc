...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::IsotropicLinearIncompElasticity::IsotropicLinearIncompElasticity(void) : _auxiliaryFactory(new pylith::materials::AuxiliaryFactoryElastic),
...
void pylith::materials::IsotropicLinearIncompElasticity::deallocate(void)
{
...
void pylith::materials::IsotropicLinearIncompElasticity::useReferenceState(const bool value)
{
...
// ---------------------------------------------------------------------------------------------------------------------
// Use reference stress and strain in computation of stress and strain?
bool pylith::materials::IsotropicLinearIncompElasticity::useReferenceState(void) const
{
...
void pylith::materials::IsotropicLinearIncompElasticity::addAuxiliarySubfields(void)
{
    PYLITH_METHOD_BEGIN;
...
pylith::materials::IsotropicLinearIncompElasticity::getKernelResidualStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc f1u =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearIncompElasticity3D::f1u : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearIncompElasticityPlaneStrain::f1u
...
pylith::materials::IsotropicLinearIncompElasticity::getKernelResidualPressure(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc f0p = (!_useReferenceState) ? pylith::fekernels::IsotropicLinearIncompElasticity::f0p : pylith::fekernels::IsotropicLinearIncompElasticity::f0p_refstate;
...
pylith::materials::IsotropicLinearIncompElasticity::getKernelJacobianElasticConstants(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jg3uu =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearIncompElasticity3D::Jf3uu : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearIncompElasticityPlaneStrain::Jf3uu
                                                                                                        : NULL;
...
pylith::materials::IsotropicLinearIncompElasticity::getKernelDerivedCauchyStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc kernel =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearIncompElasticity3D::cauchyStress : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearIncompElasticityPlaneStrain::cauchyStress
