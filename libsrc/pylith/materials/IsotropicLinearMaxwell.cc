...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::IsotropicLinearMaxwell::IsotropicLinearMaxwell(void) : _auxiliaryFactory(new pylith::materials::AuxiliaryFactoryViscoelastic),
...
void pylith::materials::IsotropicLinearMaxwell::deallocate(void)
{
...
// strain?
void pylith::materials::IsotropicLinearMaxwell::useReferenceState(const bool value)
{
...
// Use reference stress and strain in computation of stress and
// strain?
bool pylith::materials::IsotropicLinearMaxwell::useReferenceState(void) const
{
...
void pylith::materials::IsotropicLinearMaxwell::addAuxiliarySubfields(void)
{
    PYLITH_METHOD_BEGIN;
...
pylith::materials::IsotropicLinearMaxwell::getKernelResidualStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc f1u =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwell3D::f1v : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwellPlaneStrain::f1v
...
pylith::materials::IsotropicLinearMaxwell::getKernelJacobianElasticConstants(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf3uu =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwell3D::Jf3vu : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwellPlaneStrain::Jf3vu
                                                                                               : NULL;
...
pylith::materials::IsotropicLinearMaxwell::getKernelDerivedCauchyStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc kernel =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwell3D::cauchyStress : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwellPlaneStrain::cauchyStress
...
void pylith::materials::IsotropicLinearMaxwell::updateKernelConstants(pylith::real_array *kernelConstants,
...
void pylith::materials::IsotropicLinearMaxwell::addKernelsUpdateStateVars(std::vector<ProjectKernels> *kernels,
                                                                          const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const PetscPointFunc funcViscousStrain =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwell3D::updateViscousStrain : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwellPlaneStrain::updateViscousStrain
                                                                                                             : NULL;
    const PetscPointFunc funcTotalStrain =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwell3D::updateTotalStrain : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearMaxwellPlaneStrain::updateTotalStrain
                                                                                                           : NULL;
