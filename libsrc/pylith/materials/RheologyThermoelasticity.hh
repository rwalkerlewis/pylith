...
/** @file libsrc/materials/RheologyThermoelasticity.hh
 *
 * @brief C++ abstract base class for bulk rheologies associated with the thermoelastic equations.
 */
...
#endif // pylith_materials_rheologythermoelasticity_hh
