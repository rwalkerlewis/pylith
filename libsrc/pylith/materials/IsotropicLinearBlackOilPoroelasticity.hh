...
/**
 * @brief Isotropic linear poroelasticity with black oil formulation.
 *
 ...
 * - Formation volume factor for fluid density corrections
 *
 * The effective fluid bulk modulus is computed from the formation volume factor
 * and compressibility. The Darcy flux includes pressure-dependent viscosity.
 */
class pylith::materials::IsotropicLinearBlackOilPoroelasticity : public pylith::materials::RheologyPoroelasticity {
    friend class TestIsotropicLinearBlackOilPoroelasticity; // unit testing

    // PUBLIC METHODS //////////////////////////////////////////////////////////////////////////////////////////////////
public:

    /// Default constructor.
    IsotropicLinearBlackOilPoroelasticity(void);
...
private:
    ...
    IsotropicLinearBlackOilPoroelasticity(const IsotropicLinearBlackOilPoroelasticity&); ///< Not implemented.
    const IsotropicLinearBlackOilPoroelasticity& operator=(const IsotropicLinearBlackOilPoroelasticity&); ///< Not implemented
