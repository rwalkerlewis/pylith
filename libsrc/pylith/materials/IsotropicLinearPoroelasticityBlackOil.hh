...
/** @file libsrc/materials/IsotropicLinearPoroelasticityBlackOil.hh
 *
 * @brief C++ class for isotropic linear poroelasticityblackoil.
 */

#if !defined(pylith_materials_isotropiclinearporoelasticityblackoil_hh)
#define pylith_materials_isotropiclinearporoelasticityblackoil_hh

#include "materialsfwd.hh" // forward declarations

#include "pylith/materials/RheologyMultiphasePoroelasticity.hh" // ISA RheologyMultiphasePoroelasticity

class pylith::materials::IsotropicLinearPoroelasticityBlackOil : public pylith::materials::RheologyMultiphasePoroelasticity {
    friend class TestIsotropicLinearPoroelasticityBlackOil; // unit testing

    // PUBLIC METHODS //////////////////////////////////////////////////////////////////////////////////////////////////
public:

    /// Default constructor.
    IsotropicLinearPoroelasticityBlackOil(void);
...
private:
    ...
    IsotropicLinearPoroelasticityBlackOil(const IsotropicLinearPoroelasticityBlackOil&); ///< Not implemented.
    const IsotropicLinearPoroelasticityBlackOil& operator=(const IsotropicLinearPoroelasticityBlackOil&); ///< Not
                                                                                                          ///< implemented
...
#endif // pylith_materials_isotropiclinearporoelasticityblackoil_hh
