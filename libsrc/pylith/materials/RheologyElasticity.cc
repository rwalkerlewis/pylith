...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::RheologyElasticity::RheologyElasticity(void) : _lhsJacobianTriggers(pylith::feassemble::Integrator::NEW_JACOBIAN_NEVER)
{
}
...
void pylith::materials::RheologyElasticity::deallocate(void) {}

// ---------------------------------------------------------------------------------------------------------------------
// Get triggers for needing to compute the elastic constants for the RHS Jacobian.
int pylith::materials::RheologyElasticity::getLHSJacobianTriggers(void) const
{
...
void pylith::materials::RheologyElasticity::updateKernelConstants(pylith::real_array *kernelConstants,
...
void pylith::materials::RheologyElasticity::addKernelsUpdateStateVars(std::vector<pylith::feassemble::IntegratorDomain::ProjectKernels> *kernels,
