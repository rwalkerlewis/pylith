...
void pylith::materials::AuxiliaryFactoryElastic::addShearModulus(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryElastic::addBulkModulus(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryElastic::addReferenceStress(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryElastic::addReferenceStrain(void)
{
    PYLITH_METHOD_BEGIN;
