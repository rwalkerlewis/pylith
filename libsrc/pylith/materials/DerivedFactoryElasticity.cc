...
void pylith::materials::DerivedFactoryElasticity::addCauchyStress(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::DerivedFactoryElasticity::addCauchyStrain(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::DerivedFactoryElasticity::addSubfields(void)
{
    PYLITH_METHOD_BEGIN;
