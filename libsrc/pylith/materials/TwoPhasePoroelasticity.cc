...
#include "pylith/materials/TwoPhasePoroelasticity.hh" // implementation of object methods

#include "pylith/materials/RheologyTwoPhasePoroelasticity.hh" // HASA RheologyTwoPhasePoroelasticity
...
#include "pylith/fekernels/TwoPhasePoroelasticity.hh" // USES TwoPhasePoroelasticity kernels
...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::TwoPhasePoroelasticity::TwoPhasePoroelasticity(void) :
    _useInertia(false),
    _useBodyForce(false),
    ...
    pylith::utils::PyreComponent::setName("twophaseporoelasticity");
} // constructor
...
void
pylith::materials::TwoPhasePoroelasticity::deallocate(void) {
    Material::deallocate();
...
// Include body force?
void
pylith::materials::TwoPhasePoroelasticity::useBodyForce(const bool value) {
...
// Include body force?
bool
pylith::materials::TwoPhasePoroelasticity::useBodyForce(void) const {
...
void
pylith::materials::TwoPhasePoroelasticity::useSourceDensity(const bool value) {
...
// Include source density?
bool
pylith::materials::TwoPhasePoroelasticity::useSourceDensity(void) const {
...
// Set bulk rheology.
void
pylith::materials::TwoPhasePoroelasticity::setBulkRheology(pylith::materials::RheologyTwoPhasePoroelasticity* const rheology) {
...
// ---------------------------------------------------------------------------------------------------------------------
// Get bulk rheology.
pylith::materials::RheologyTwoPhasePoroelasticity*
pylith::materials::TwoPhasePoroelasticity::getBulkRheology(void) const {
    return _rheology;
} // getBulkRheology
...
void
pylith::materials::TwoPhasePoroelasticity::verifyConfiguration(const pylith::topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
    PYLITH_COMPONENT_DEBUG("verifyConfiguration(solution="<<solution.getLabel()<<")");

    // Verify solution contains expected fields.
    if (!solution.hasSubfield("displacement")) {
        throw std::runtime_error("Cannot find 'displacement' field in solution; required for material 'TwoPhasePoroelasticity'.");
    } // if
    if (!solution.hasSubfield("pressure")) {
        throw std::runtime_error("Cannot find 'pressure' field in solution; required for material 'TwoPhasePoroelasticity'.");
    } // if
    switch (_formulation) {
        case QUASISTATIC:
            if (!_useInertia && !solution.hasSubfield("trace_strain")) {
                throw std::runtime_error("Cannot find 'trace_strain' field in solution; required for material 'TwoPhasePoroelasticity'.");
            } // if
            break;
        case DYNAMIC:
        case DYNAMIC_IMEX:
            if (_useInertia && !solution.hasSubfield("velocity")) {
                throw std::runtime_error("Cannot find 'velocity' field in solution; required for material 'TwoPhasePoroelasticity' with inertia.");
            } // if
    } // switch
    PYLITH_METHOD_END;
} // verifyConfiguration
...
pylith::materials::TwoPhasePoroelasticity::createIntegrator(const pylith::topology::Field& solution) {
    PYLITH_METHOD_BEGIN;
...
pylith::materials::Poroelasticity::createAuxiliaryField(const pylith::topology::Field& solution,
    ...
    auxiliaryFactory->addFluidDensityArray2P();  // 1 Fluid Density Array
    auxiliaryFactory->addFluidViscosityArray2P(); // 2 Fluid Viscosity Array
    ...
    auxiliaryFactory->addFluidSaturationArray2P(); // +1
...
pylith::topology::Field*
pylith::materials::TwoPhasePoroelasticity::createDerivedField(const pylith::topology::Field& solution,
                                                      const pylith::topology::Mesh& domainMesh) {
    PYLITH_METHOD_BEGIN;
    ...
    derivedField->setLabel("TwoPhasePoroelasticity derived field");
...
pylith::materials::TwoPhasePoroelasticity::_getAuxiliaryFactory(void) {
    assert(_rheology);
...
void
pylith::materials::TwoPhasePoroelasticity::_updateKernelConstants(const PylithReal dt) {
    assert(_rheology);
...
pylith::materials::TwoPhasePoroelasticity::_getDerivedFactory(void) {
...
void
pylith::materials::TwoPhasePoroelasticity::_setKernelsRHSResidual(pylith::feassemble::IntegratorDomain* integrator,
    ...
    switch (bitUse) {
    case 0x1:
        g0v = pylith::fekernels::TwoPhasePoroelasticity::g0v_bodyforce;
        break;
    case 0x2:
        g0v = pylith::fekernels::TwoPhasePoroelasticity::g0v_grav;
        break;
    case 0x4:
        g0p = pylith::fekernels::TwoPhasePoroelasticity::g0p_sourceDensity; // aOff for sourceDensity is 3
        break;
    case 0x3:
        g0v = pylith::fekernels::TwoPhasePoroelasticity::g0v_gravbodyforce;
        break;
    case 0x5:
        g0v = pylith::fekernels::TwoPhasePoroelasticity::g0v_bodyforce;
        g0p = pylith::fekernels::TwoPhasePoroelasticity::g0p_sourceDensity_body; // aOff for sourceDensity is 4
        break;
    case 0x6:
        g0v = pylith::fekernels::TwoPhasePoroelasticity::g0v_grav;
        g0p = pylith::fekernels::TwoPhasePoroelasticity::g0p_sourceDensity_grav;  // aOff for sourceDensity is 4
        break;
    case 0x7:
        g0v = pylith::fekernels::TwoPhasePoroelasticity::g0v_gravbodyforce;
        g0p = pylith::fekernels::TwoPhasePoroelasticity::g0p_sourceDensity_grav_body;  // aOff for sourceDensity is 5
        break;
    case 0x0:
            break;
    default:
    ...
    switch (_formulation) {
        case QUASISTATIC : {
            ...
            // 2) Volumetric Strain
            const PetscPointFunc g0e =  pylith::fekernels::TwoPhasePoroelasticity::g0e;
...
pylith::materials::Poroelasticity::_setKernelsRHSJacobian(pylith::feassemble::IntegratorDomain* integrator, const topology::Field& solution) const {
    ...
    switch (_formulation) {
        case QUASISTATIC: {
            ...
            const PetscPointJac Jg1eu = pylith::fekernels::TwoPhasePoroelasticity::Jg1eu;
            ...
            const PetscPointJac Jg0ee = pylith::fekernels::TwoPhasePoroelasticity::Jg0ee;
...
void
pylith::materials::TwoPhasePoroelasticity::_setKernelsLHSResidual(pylith::feassemble::IntegratorDomain* integrator,
                                                            const topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::TwoPhasePoroelasticity::_setKernelsLHSJacobian(pylith::feassemble::IntegratorDomain* integrator,
                                                          const topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::TwoPhasePoroelasticity::_setKernelsUpdateStateVars(pylith::feassemble::IntegratorDomain* integrator,
                                                                        const topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::TwoPhasePoroelasticity::_setKernelsDerivedField(pylith::feassemble::IntegratorDomain* integrator,
                                                       const topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
    ...
    const PetscPointFunc strainKernel =
        (3 == spaceDim) ? pylith::fekernels::TwoPhasePoroelasticity3D::cauchyStrain :
        (2 == spaceDim) ? pylith::fekernels::TwoPhasePoroelasticityPlaneStrain::cauchyStrain :
        NULL;
