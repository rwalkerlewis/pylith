...
pylith::materials::Poroelasticity::_setKernelsDerivedField(pylith::feassemble::IntegratorDomain* integrator,
    ...
    const PetscPointFunc strainKernel =
        (3 == spaceDim) ? pylith::fekernels::Poroelasticity3D::infinitesimalStrain_asVector :
        (2 == spaceDim) ? pylith::fekernels::PoroelasticityPlaneStrain::infinitesimalStrain_asVector :
        NULL;
