...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::IsotropicLinearGenMaxwell::IsotropicLinearGenMaxwell(void) : _auxiliaryFactory(new pylith::materials::AuxiliaryFactoryViscoelastic),
...
void pylith::materials::IsotropicLinearGenMaxwell::deallocate(void)
{
...
// strain?
void pylith::materials::IsotropicLinearGenMaxwell::useReferenceState(const bool value)
{
...
// Use reference stress and strain in computation of stress and
// strain?
bool pylith::materials::IsotropicLinearGenMaxwell::useReferenceState(void) const
{
...
void pylith::materials::IsotropicLinearGenMaxwell::addAuxiliarySubfields(void)
{
    PYLITH_METHOD_BEGIN;
...
pylith::materials::IsotropicLinearGenMaxwell::getKernelResidualStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc f1u =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwell3D::f1v : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwellPlaneStrain::f1v
...
pylith::materials::IsotropicLinearGenMaxwell::getKernelJacobianElasticConstants(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf3uu =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwell3D::Jf3vu : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwellPlaneStrain::Jf3vu
                                                                                                  : NULL;
...
pylith::materials::IsotropicLinearGenMaxwell::getKernelDerivedCauchyStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc kernel =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwell3D::cauchyStress : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwellPlaneStrain::cauchyStress
...
void pylith::materials::IsotropicLinearGenMaxwell::updateKernelConstants(pylith::real_array *kernelConstants,
...
void pylith::materials::IsotropicLinearGenMaxwell::addKernelsUpdateStateVars(std::vector<ProjectKernels> *kernels,
                                                                             const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const PetscPointFunc funcViscousStrain =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwell3D::updateViscousStrain : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwellPlaneStrain::updateViscousStrain
                                                                                                                : NULL;
    const PetscPointFunc funcTotalStrain =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwell3D::updateTotalStrain : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearGenMaxwellPlaneStrain::updateTotalStrain
                                                                                                              : NULL;
