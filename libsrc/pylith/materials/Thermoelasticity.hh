...
public:
    ...
    /** Set bulk rheology.
     *
     * @param[in] rheology Bulk rheology for thermoelasticity.
     */
    void setBulkRheology(pylith::materials::RheologyThermoelasticity* const rheology);

    /** Get bulk rheology.
     *
     * @returns Bulk rheology for thermoelasticity.
     */
    pylith::materials::RheologyThermoelasticity* getBulkRheology(void) const;
