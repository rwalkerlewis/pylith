...
/** @file libsrc/materials/Thermoelasticity.hh
 *
 * @brief C++ class for solving the thermoelastic equations.
 */

#if !defined(pylith_materials_thermoelasticity_hh)
#define pylith_materials_thermoelasticity_hh

#include "materialsfwd.hh" // forward declarations

#include "pylith/materials/Material.hh" // ISA Material

class pylith::materials::Thermoelasticity : public pylith::materials::Material {
    friend class TestThermoelasticity; // unit testing

    // PUBLIC METHODS //////////////////////////////////////////////////////////////////////////////////////////////////
public:

    /// Default constructor.
    Thermoelasticity(void);
     ...
     */
    void setBulkRheology(pylith::materials::RheologyThermoelasticity* const rheology);
...
private:
    ...
    pylith::materials::RheologyThermoelasticity* _rheology; ///< Bulk rheology for thermoelasticity.
    pylith::materials::DerivedFactoryElasticity* _derivedFactory; ///< Factory for creating derived fields.

    // NOT IMPLEMENTED /////////////////////////////////////////////////////////////////////////////////////////////////
private:

    Thermoelasticity(const Thermoelasticity&); ///< Not implemented.
    const Thermoelasticity& operator=(const Thermoelasticity&); /// Not implemented.

};

// class Thermoelasticity

#endif // pylith_materials_thermoelasticity_hh
