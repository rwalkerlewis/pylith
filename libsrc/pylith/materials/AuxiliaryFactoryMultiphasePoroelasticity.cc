...
#include "AuxiliaryFactoryMultiphasePoroelasticity.hh" // implementation of object methods
...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::AuxiliaryFactoryMultiphasePoroelasticity::AuxiliaryFactoryMultiphasePoroelasticity(void) {
    GenericComponent::setName("auxiliaryfactorymultiphaseporoelasticity");
} // constructor
...
void
pylith::materials::AuxiliaryFactoryMultiphasePoroelasticity::addBodyForce(void) {
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::AuxiliaryFactoryMultiphasePoroelasticity::addGravityField(spatialdata::spatialdb::GravityField* gf) {
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::AuxiliaryFactoryMultiphasePoroelasticity::addPorosity(void) { // porosity
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::AuxiliaryFactoryMultiphasePoroelasticity::addSolidDensity(void) {
    PYLITH_METHOD_BEGIN;
