...
// ----------------------------------------------------------------------
// Constructor
pylith::meshio::ExodusII::ExodusII(void) : _filename(""),
                                           _file(0)
{ // constructor
} // constructor
...
pylith::meshio::ExodusII::ExodusII(const char *filename) : _filename(filename),
                                                           _file(0)
{ // constructor
  open();
} // constructor
...
void pylith::meshio::ExodusII::deallocate(void)
{ // deallocate
  PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
// Set filename.
void pylith::meshio::ExodusII::filename(const char *name)
{ // filename
  _filename = name;
} // filename
...
// ----------------------------------------------------------------------
// Open file.
void pylith::meshio::ExodusII::open(void)
{ // open
  PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
// Close file.
void pylith::meshio::ExodusII::close(void)
{ // close
  PYLITH_METHOD_BEGIN;

  if (_file)
  {
    int err = nc_close(_file);
    _file = 0;
    if (err != NC_NOERR)
    {
      std::ostringstream msg;
...
bool pylith::meshio::ExodusII::hasDim(const char *name,
                                      int *id) const
{ // hasDim
  PYLITH_METHOD_BEGIN;
...
bool pylith::meshio::ExodusII::hasAtt(const char *name,
                                      int *id) const
{ // hasAtt
  PYLITH_METHOD_BEGIN;
...
bool pylith::meshio::ExodusII::hasVar(const char *name,
                                      int *id) const
{ // hasVar
  PYLITH_METHOD_BEGIN;
...
int pylith::meshio::ExodusII::getDim(const char *name) const
{ // getDim
  PYLITH_METHOD_BEGIN;
...
void pylith::meshio::ExodusII::getVar(PylithScalar *values,
                                      int *dims,
                                      int ndims,
...
void pylith::meshio::ExodusII::getVar(int *values,
                                      int *dims,
                                      int ndims,
                                      const char *name) const
{ // getVar
...
void pylith::meshio::ExodusII::getVar(string_vector *values,
                                      int dim,
                                      const char *name) const
{ // getVar
  PYLITH_METHOD_BEGIN;
