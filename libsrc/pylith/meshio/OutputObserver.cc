...
// ------------------------------------------------------------------------------------------------
// Constructor
pylith::meshio::OutputObserver::OutputObserver(void) : _timeScale(1.0),
                                                       _writer(NULL),
                                                       _trigger(NULL),
                                                       _outputBasisOrder(1)
{
...
void pylith::meshio::OutputObserver::deallocate(void)
{
    if (_writer)
    {
        _writer->close();
...
void pylith::meshio::OutputObserver::setTrigger(pylith::meshio::OutputTrigger *const trigger)
{
...
void pylith::meshio::OutputObserver::setWriter(DataWriter *const writer)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::meshio::OutputObserver::setOutputBasisOrder(const int value)
{
    PYLITH_METHOD_BEGIN;
...
// ------------------------------------------------------------------------------------------------
// Set time scale.
void pylith::meshio::OutputObserver::setTimeScale(const PylithReal value)
{
    if (value <= 0.0)
    {
        std::ostringstream msg;
...
void pylith::meshio::OutputObserver::_appendField(const PylithReal t,
