...
class pylith::meshio::DataWriter : public pylith::utils::PyreComponent
{ // DataWriter
    // PUBLIC METHODS ///////////////////////////////////////////////////////
public:
    /// Constructor
     ...
     */
    virtual DataWriter *clone(void) const = 0;
     ...
     */
    virtual void open(const pylith::topology::Mesh &mesh,
                      const bool isInfo);
     ...
     */
    virtual void openTimeStep(const PylithScalar t,
                              const topology::Mesh &mesh);

    /// Cleanup after writing data for a time step.
    virtual void closeTimeStep(void);
     ...
     */
    virtual void writeVertexField(const PylithScalar t,
     ...
     */
    virtual void writeCellField(const PylithScalar t,
     ...
     */
    virtual void writePointNames(const pylith::string_vector &names,
...
protected:
     ...
     * @param[in] mesh Finite-element mesh.
     */
    static void getCoordsGlobalVec(PetscVec *coordinatesVec,
                                   const pylith::topology::Mesh &mesh);
