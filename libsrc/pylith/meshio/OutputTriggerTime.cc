...
// ---------------------------------------------------------------------------------------------------------------------
// Constructor
pylith::meshio::OutputTriggerTime::OutputTriggerTime(void) : _timeSkip(0.0),
...
void pylith::meshio::OutputTriggerTime::setTimeSkip(const double value)
{
...
bool pylith::meshio::OutputTriggerTime::shouldWrite(const PylithReal t,
