...
// ---------------------------------------------------------------------------------------------------------------------
// Constructor
pylith::meshio::OutputTriggerStep::OutputTriggerStep(void) : _numStepsSkip(0),
...
void pylith::meshio::OutputTriggerStep::setNumStepsSkip(const int value)
{
...
int pylith::meshio::OutputTriggerStep::getNumStepsSkip(void) const
{
...
bool pylith::meshio::OutputTriggerStep::shouldWrite(const PylithReal t,
