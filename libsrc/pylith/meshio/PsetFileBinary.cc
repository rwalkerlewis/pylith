...
pylith::meshio::PsetFileBinary::PsetFileBinary(const char *filename,
                                               ...
                                               const bool ioInt32,
                                               const bool isRecordHeader32Bit) : PsetFile(filename),
...
void pylith::meshio::PsetFileBinary::read(std::vector<Pset> *groups)
{ // read
    PYLITH_METHOD_BEGIN;
...
void pylith::meshio::PsetFileBinary::write(const std::vector<Pset> &groups)
{ // write
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void pylith::meshio::PsetFileBinary::_readHeader(std::ifstream &fin)
{ // _readHeader
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void pylith::meshio::PsetFileBinary::_writeHeader(std::ofstream &fout)
{ // _writeHeader
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void pylith::meshio::PsetFileBinary::_readPset32(std::ifstream &fin,
                                                 Pset *group)
{ // _readPset32
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void pylith::meshio::PsetFileBinary::_writePset32(std::ofstream &fout,
                                                  const Pset &group)
{ // _writePset32
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void pylith::meshio::PsetFileBinary::_readPset64(std::ifstream &fin,
                                                 Pset *group)
{ // _readPset64
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void pylith::meshio::PsetFileBinary::_writePset64(std::ofstream &fout,
                                                  const Pset &group)
{ // _writePset64
    PYLITH_METHOD_BEGIN;
