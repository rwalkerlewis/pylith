...
// void
// pylith::bc::NeumannUserFn::setConstrainedDOF(const int* flags,
//                                                const int size) {
...
// pylith::bc::NeumannUserFn::getConstrainedDOF(void) const {
...
void
pylith::bc::NeumannUserFn::setUserFn(PetscUserFieldFunc fn) {
