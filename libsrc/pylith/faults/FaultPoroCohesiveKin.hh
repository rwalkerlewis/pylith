...
/** @file libsrc/faults/FaultPoroCohesiveKin.hh
 *
 * @brief C++ implementation for a undrained poroelastic fault surface with kinematic
 * (prescribed) slip implemented with cohesive elements.
 */

#if !defined(pylith_faults_faultporocohesivekin_hh)
#define pylith_faults_faultporocohesivekin_hh
...
class pylith::faults::FaultPoroCohesiveKin : public pylith::faults::FaultCohesive {
    // ** TO DO **
    // Implement this friend class
    friend class TestFaultPoroCohesiveKin; // unit testing
...
private:
    ...
    FaultPoroCohesiveKin(const FaultPoroCohesiveKin&); ///< Not implemented
    const FaultPoroCohesiveKin& operator=(const FaultPoroCohesiveKin&); ///< Not implemented.
...
#endif // pylith_faults_faultporocohesivekin_hh
