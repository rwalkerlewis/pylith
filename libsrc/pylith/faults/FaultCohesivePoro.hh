...
/** @file libsrc/faults/FaultCohesivePoro.hh
 *
 * @brief C++ abstract base class for a poroelastic fault interface implemented with
 * cohesive cells.
 */

#if !defined(pylith_faults_faultcohesiveporo_hh)
#define pylith_faults_faultcohesiveporo_hh
...
class pylith::faults::FaultCohesivePoro : public pylith::problems::Physics {
    friend class TestFaultCohesivePoro; // unit testing

    // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:

    /// Default constructor.
    FaultCohesivePoro(void);

    /// Destructor.
    virtual ~FaultCohesivePoro(void);
...
private:
    ...
    FaultCohesivePoro(const FaultCohesivePoro&); ///< Not implemented
    const FaultCohesivePoro& operator=(const FaultCohesivePoro&); ///< Not implemented

}; // class FaultCohesivePoro

#endif // pylith_faults_faultcohesiveporo_hh
