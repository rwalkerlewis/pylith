...
void
pylith::faults::KinSrcPoroStep::permeability_tangentialFn(const PylithInt dim,
                                                          const PylithInt numS,
                                                          const PylithInt numA,
                                                          const PylithInt sOff[],
                                                          const PylithInt sOff_x[],
    ...
    permeability_tangential[0] += 0.0;

} // permeability_tangentialFn


// ---------------------------------------------------------------------------------------------------------------------
// permeability_normal time function kernel.
void
pylith::faults::KinSrcPoroStep::permeability_normalFn(const PylithInt dim,
                                                      const PylithInt numS,
                                                      const PylithInt numA,
                                                      const PylithInt sOff[],
                                                      const PylithInt sOff_x[],
...
pylith::faults::KinSrcPoroStep::_auxiliaryFieldSetup(const spatialdata::units::Nondimensional& normalizer,
    ...
    _permeability_tangentialFnKernel = pylith::faults::KinSrcPoroStep::permeability_tangentialFn; // 4
    _permeability_normalFnKernel = pylith::faults::KinSrcPoroStep::permeability_normalFn; // 5
    _fluid_viscosityFnKernel = pylith::faults::KinSrcPoroStep::fluid_viscosityFn; // 6
