...
# @file pylith/problems/SolnDispPresTracStrainVelTdotPdotBO.py
#
# @brief Python subfields container with displacement, pore pressure, and trace strain subfields, along with their time derivatives, including a three
# phase black oil model.

from pylith.utils.PetscComponent import PetscComponent
from .Solution import Solution as SolutionBase


class SolnDispPresTracStrainVelPdotTdotBO(PetscComponent):
    ...
    pressure = pythia.pyre.inventory.facility(
        "pressure", family="soln_subfield", factory=SubfieldBlackOilPressure)
    ...
    from .SubfieldBlackOilPressureDot import SubfieldBlackOilPressureDot
    pressure_t = pythia.pyre.inventory.facility(
        "pressure_t", family="soln_subfield", factory=SubfieldBlackOilPressureDot)
...
class Solution(SolutionBase):
    ...
    subfields = pythia.pyre.inventory.facilityArray(
        "subfields", family="soln_subfields", itemFactory=subfieldFactory, factory=SolnDispPresTracStrainVelPdotTdotBO)
