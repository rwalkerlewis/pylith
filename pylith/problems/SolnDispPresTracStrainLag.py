...
# @file pylith/problems/SolnDispPresTracStrainLag.py
#
# @brief Python subfields container with displacement, pore pressure, trace strain subfields.

from pylith.utils.PetscComponent import PetscComponent
from .Solution import Solution as SolutionBase


class SolnDispPresTracStrainLag(PetscComponent):
    ...
    def __init__(self, name="solndispprestracstrainlag"):
        """Constructor.
        """
...
class Solution(SolutionBase):
    ...
    subfields = pythia.pyre.inventory.facilityArray(
        "subfields", family="soln_subfields", itemFactory=subfieldFactory, factory=SolnDispPresTracStrainLag)
