...
# @file pylith/problems/SolnDispPresTracStrainVelPdotTSdot.py
#
...
class SolnDispPresTracStrainVelPdotTSdot(PetscComponent):
    ...
    pressure_t = pythia.pyre.inventory.facility("pressure_t", family="soln_subfield", factory=SubfieldPressure_t)
    pressure_t.meta['tip'] = "Pressure time derivative subfield."

    from .SubfieldTraceStrain_t import SubfieldTraceStrain_t
    traceStrain_t = pythia.pyre.inventory.facility("trace_strain_t", family="soln_subfield", factory=SubfieldTraceStrain_t)
    traceStrain_t.meta['tip'] = "Trace strain time derivative subfield."

    # PUBLIC METHODS /////////////////////////////////////////////////////

    def __init__(self, name="solndispprestracstrainvelpdottsdot"):
        """Constructor.
        """
    ...
    def components(self):
        ...
        """
        return [self.displacement, self.pressure, self.traceStrain, self.velocity, self.pressure_t, self.traceStrain_t]
...
class Solution(SolutionBase):
    ...
    subfields = pythia.pyre.inventory.facilityArray(
        "subfields", family="soln_subfields", itemFactory=subfieldFactory, factory=SolnDispPresTracStrainVelPdotTSdot)
