...
from .faults import FaultCohesivePoro as ModuleFaultCohesivePoro
...
class FaultCohesivePoro(Physics, ModuleFaultCohesivePoro):
    """
    ...
    def preinitialize(self, problem):
        ...
        ModuleFaultCohesivePoro.setSurfaceLabelName(self, self.labelName)
        ModuleFaultCohesivePoro.setSurfaceLabelValue(self, self.labelValue)
        ModuleFaultCohesivePoro.setBuriedEdgesLabelName(self, self.edgeName)
        ModuleFaultCohesivePoro.setBuriedEdgesLabelValue(self, self.edgeValue)
        ModuleFaultCohesivePoro.setRefDir1(self, self.refDir1)
        ModuleFaultCohesivePoro.setRefDir2(self, self.refDir2)
        return
