...
class DerivedSubfieldsThermoelasticity(PetscComponent):
    """
    Derived subfields associated with the thermoelasticity equations.

    For thermoelastic materials these derived subfields are available for output 
    in addition to the solution and auxiliary subfields.
    """
    DOC_CONFIG = {
        "cfg": """
            # The basis order for stress and strain should be at least 1 less than the basis order for displacement.
            [pylithapp.problem.materials.mat_thermoelastic.derived_subfields]
    ...
    def __init__(self, name="derivedsubfieldsthermoelasticity"):
        """Constructor.
        """
...
def derived_subfields():
    """Factory associated with DerivedSubfieldsThermoelasticity.
    """
    return DerivedSubfieldsThermoelasticity()
