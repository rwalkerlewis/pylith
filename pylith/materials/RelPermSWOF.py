...
# @file pylith/materials/RelPermSWOF.py
#
# @brief Python object for water / oil relative permeability tables.
#
...
class SWOF(Component, ModuleTimeHistory):
    """
    ...
    def _createModuleObj(self):
        ...
        """
        ModuleSWOF.__init__(self)


# FACTORIES ////////////////////////////////////////////////////////////

def createWriter(filename, label="SWOF writer"):
    writer = SWOF()
