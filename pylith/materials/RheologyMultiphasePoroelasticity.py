...
# ----------------------------------------------------------------------
#
# @file pylith/materials/RheologyMultiphasePoroelasticity.py
#
...
from .materials import RheologyMultiphasePoroelasticity as ModuleRheology


class RheologyMultiphasePoroelasticity(PetscComponent, ModuleRheology):
    ...
    def __init__(self, name):
        """Constructor.
        """
        PetscComponent.__init__(self, name, facility="rheologymultiphaseporoelasticity")
        return
    ...
    def preinitialize(self, problem):
        ...
        comm = mpi_comm_world()
        if 0 == comm.rank:
            self._info.log("Performing minimal initialization of multiphaseporoelasticity rheology '%s'." %
                           self.aliases[-1])
