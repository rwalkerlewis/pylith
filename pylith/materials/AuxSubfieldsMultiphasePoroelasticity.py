...
# ----------------------------------------------------------------------
#
# @file pylith/materials/AuxSubieldsMultiphasePoroelasticity.py
#
# @brief Python container for multiphaseporoelasticity equation subfields.

from pylith.utils.PetscComponent import PetscComponent


class AuxSubfieldsMultiphasePoroelasticity(PetscComponent):
    """Python container for multiphaseporoelasticity equation subfields.
    ...
    def __init__(self, name="auxsubfieldsmultiphaseporoelasticity"):
        """Constructor.
        """
...
def auxiliary_subfields():
    """Factory associated with AuxSubfieldsMultiphasePoroelasticity.
    """
    return AuxSubfieldsMultiphasePoroelasticity()
