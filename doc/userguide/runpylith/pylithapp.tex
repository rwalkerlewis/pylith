...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    ...
    \object{SolnDispPresTracStrain} & displacement, pressure, trace\_strain   & Poroelasticity w/o inertia and faults   \\
    \object{SolnDispPresVel}        & displacement, pressure, velocity        & Poroelasticity w/inertia and w/o faults \\
    \bottomrule
  \end{tabular}
\end{table}
