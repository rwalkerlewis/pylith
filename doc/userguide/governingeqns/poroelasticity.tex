% ----------------------------------------------------------------------
\section{Poroelasticity with Infinitesimal Strain, without Inertia}
...
We begin with the elasticity equilibrium equation including the inertial term,
\begin{gather}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcp{3.5in}}
    ...
    Derived quantities & $\tensor{\sigma}$ & Cauchy stress tensor \\
                       ...
                       & $\zeta$ & Variation of fluid content (variation of fluid vol. per unit vol. of PM) \\
