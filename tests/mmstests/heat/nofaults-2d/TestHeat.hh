...
/// C++ class for testing Heat using a variety of MMS tests.
class pylith::TestHeat : public pylith::testing::MMSTest {
    // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:
...
protected:
    ...
    TestHeat_Data* _data; ///< Test parameters.

}; // class TestHeat

// ================================================================================================
class pylith::TestHeat_Data {
    // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:
...
public:
    ...
    pylith::materials::Heat material; ///< Heat material.
    pylith::materials::IsotropicHeat rheology; ///< Bulk rheology for materials.
