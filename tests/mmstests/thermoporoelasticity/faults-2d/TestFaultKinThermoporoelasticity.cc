...
#include "TestFaultKinThermoporoelasticity.hh" // Implementation of class methods
...
// ------------------------------------------------------------------------------------------------
// Constructor.
pylith::TestFaultKinThermoporoelasticity::TestFaultKinThermoporoelasticity(TestFaultKinThermoporoelasticity_Data* data) :
    _data(data) {
    assert(_data);
...
// ------------------------------------------------------------------------------------------------
// Destructor.
pylith::TestFaultKinThermoporoelasticity::~TestFaultKinThermoporoelasticity(void) {
...
void
pylith::TestFaultKinThermoporoelasticity::_initialize(void) {
    PYLITH_METHOD_BEGIN;
    assert(_mesh);
    assert(_data);
...
void
pylith::TestFaultKinThermoporoelasticity::_setExactSolution(void) {
...
// ------------------------------------------------------------------------------------------------
// Constructor
pylith::TestFaultKinThermoporoelasticity_Data::TestFaultKinThermoporoelasticity_Data(void) :
    spaceDim(2),
