...
protected:
    ...
    void _setExactSolution(void) {
        ...
        CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, label, 24, 0, 0, 1, pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0_mms_qt_u, 1, NULL);
        PYLITH_CHECK_ERROR(err);
        err = PetscWeakFormSetIndexResidual(wf, label, 24, 1, 0, 1, pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0_mms_qt_p, 1, NULL);
        PYLITH_CHECK_ERROR(err);
    } // _setExactSolution
