...
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT :
    ...
    static const char* sold_bulk_modulus_units(void) {
        return "Pa";
...
protected:
    ...
    void setUp(void) {
        ...
        _data->auxDB->addValue("fluid_viscosity", fluid_viscosity, fluid_viscosity());
    ...
    void _setExactSolution(void) {
        ...
        err = PetscDSSetExactSolution(prob, 3, solnkernel_vel, NULL);CPPUNIT_ASSERT(!err);
        err = PetscDSSetExactSolution(prob, 4, solnkernel_pressure_t, NULL);CPPUNIT_ASSERT(!err);
        err = PetscDSSetExactSolution(prob, 5, solnkernel_trace_strain_t, NULL);CPPUNIT_ASSERT(!err);
    } // _setExactSolution
...
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_TriP2 :
    ...
    void setUp(void) {
        ...
        static const pylith::topology::Field::Discretization _solnDiscretizations[6] = {
            ...
            pylith::topology::Field::Discretization(1, 2), // pressure_t
            pylith::topology::Field::Discretization(1, 2), // trace_strain_t
        };
...
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_TriP3 :
    ...
    void setUp(void) {
        ...
        static const pylith::topology::Field::Discretization _solnDiscretizations[6] = {
            ...
            pylith::topology::Field::Discretization(2, 3), // velocity
            pylith::topology::Field::Discretization(1, 3), // pressure_t
            pylith::topology::Field::Discretization(1, 3), // trace_strain_t
        };
        _data->solnDiscretizations = const_cast<pylith::topology::Field::Discretization*>(_solnDiscretizations);
...
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity2D_Quadratic_QuadQ3);
