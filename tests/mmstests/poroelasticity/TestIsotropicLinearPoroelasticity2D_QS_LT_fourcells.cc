...
// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells : public pylith::mmstests::TestIsotropicLinearPoroelasticity
{
...
protected:
    void setUp(void)
    {
        ...
        _bcPressure->setConstrainedDOF(constrainedPresDOF, numConstrainedPres);
    ...
    void _setExactSolution(void)
    {
        ...
        CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, NULL, 0, 1, 1, pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0_mms_ql_p, 0, NULL);
        CPPUNIT_ASSERT(!err);
...
const double pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells::LENGTHSCALE = 1.0;
...
const double pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells::XMAX = 4.0;

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells_TriP1 : public pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells
{
...
// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells_TriP2 : public pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells
{
...
// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells_TriP3 : public pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells
{
...
// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells_QuadQ1 : public pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells
{
...
// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells_QuadQ2 : public pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells
{
...
// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells_QuadQ3 : public pylith::mmstests::TestIsotropicLinearPoroelasticity2D_QS_LT_fourcells
{
