 ...
 *
 * @brief C++ abstract base class for testing poroelastic faults with prescribed slip.
 */
...
public:
    ...
    pylith::materials::RheologyPoroelasticity* rheology; ///< Poroelastic rheology for material.
    ...
    pylith::faults::KinSrcPoro* kinsrcporo; ///< Kinematic description of fault rupture.
