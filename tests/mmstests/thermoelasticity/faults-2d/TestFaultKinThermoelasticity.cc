...
#include "TestFaultKinThermoelasticity.hh" // Implementation of class methods
...
// ------------------------------------------------------------------------------------------------
// Constructor.
pylith::TestFaultKinThermoelasticity::TestFaultKinThermoelasticity(TestFaultKinThermoelasticity_Data* data) :
    _data(data) {
    assert(_data);
...
// ------------------------------------------------------------------------------------------------
// Destructor.
pylith::TestFaultKinThermoelasticity::~TestFaultKinThermoelasticity(void) {
...
void
pylith::TestFaultKinThermoelasticity::_initialize(void) {
    PYLITH_METHOD_BEGIN;
    assert(_mesh);
    assert(_data);
    ...
    factory.addTemperature(_data->solnDiscretizations[iField++]);
    if (pylith::problems::Physics::QUASISTATIC == _data->formulation) {
        ...
        assert(4 == _data->numSolnSubfieldsDomain);
        factory.addVelocity(_data->solnDiscretizations[iField++]);
        factory.addTemperatureDot(_data->solnDiscretizations[iField++]);
    } // if/else
...
void
pylith::TestFaultKinThermoelasticity::_setExactSolution(void) {
...
// ------------------------------------------------------------------------------------------------
// Constructor
pylith::TestFaultKinThermoelasticity_Data::TestFaultKinThermoelasticity_Data(void) :
    spaceDim(2),
