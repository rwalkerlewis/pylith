...
namespace pylith {
    class TestThermoelasticity;
    class TestThermoelasticity_Data;
}

// ================================================================================================
class pylith::TestThermoelasticity : public pylith::testing::MMSTest {
    // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:
     ...
     */
    TestThermoelasticity(TestThermoelasticity_Data* data);

    /// Destructor.
    ~TestThermoelasticity(void);
...
protected:
    ...
    TestThermoelasticity_Data* _data; ///< Test parameters.

}; // class TestThermoelasticity

// ================================================================================================
class pylith::TestThermoelasticity_Data {
    // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:

    /// Constructor
    TestThermoelasticity_Data(void);
...
public:
    ...
    pylith::materials::Thermoelasticity material; ///< Thermoelasticity material.
    pylith::materials::IsotropicLinearThermoelasticity rheology; ///< Bulk rheology.
    ...
    /// Array of functions providing exact solution (displacement, temperature).
