...
class TestCase(FullTestCase):
    """Thermoporoelasticity fullscale test (constant solution)."""
...
class TestTriGmsh(TestCase):
    def setUp(self):
        self.name = "thermoporo_tri"
        self.mesh = meshes.TriGmsh()
        super().setUp()
        TestCase.run_pylith(self, self.name, ["thermoporo.cfg", "thermoporo_tri.cfg"])


class TestQuadGmsh(TestCase):
    def setUp(self):
        self.name = "thermoporo_quad"
        self.mesh = meshes.QuadGmsh()
        super().setUp()
        TestCase.run_pylith(self, self.name, ["thermoporo.cfg", "thermoporo_quad.cfg"])
