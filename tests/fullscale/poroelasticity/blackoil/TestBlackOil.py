...
class TestCase(FullTestCase):
    ...
    def setUp(self):
        defaults = {
            ...
            "exact_soln": blackoil_soln.AnalyticalSoln(),
            "mesh": self.mesh,
        }
        self.checks = [
            Check(
...
class TestQuadGmsh(TestCase):
    ...
    def setUp(self):
        self.name = "blackoil_quad"
        self.mesh = meshes.QuadGmsh()
        super().setUp()

        TestCase.run_pylith(self, self.name, ["blackoil.cfg", "blackoil_quad.cfg"])
        return
...
class TestTriGmsh(TestCase):
    ...
    def setUp(self):
        self.name = "blackoil_tri"
        self.mesh = meshes.TriGmsh()
        super().setUp()

        TestCase.run_pylith(self, self.name, ["blackoil.cfg", "blackoil_tri.cfg"])
        return
