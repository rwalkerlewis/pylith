/**
 * Dynamic simulation with spontaneous rupture.
 *
...
// --------------------------------------------------------------------------------------------------
DynamicSpontaneousRupture::DynamicSpontaneousRupture(void) {
...
// --------------------------------------------------------------------------------------------------
void
DynamicSpontaneousRupture::_computeLHSResidual(const PetscReal t,
                                               const PetscReal dt,
...
// --------------------------------------------------------------------------------------------------
void
DynamicSpontaneousRupture::_computeRHSResidual(const PetscReal t,
                                               const PetscReal dt,
                                               const PetscVec solution,
                                               PetscVec residual) {
    PetscErrorCode err = 0;
...
// --------------------------------------------------------------------------------------------------
void
DynamicSpontaneousRupture::_computeLHSJacobian(const PetscReal t,
                                               const PetscReal dt,
                                               const PetscVec solution,
                                               const PetscVec solutionDot,
