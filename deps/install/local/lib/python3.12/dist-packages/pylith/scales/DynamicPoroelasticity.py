...
class DynamicPoroelasticity(General):
    """
    Convenience object for nondimensionalizing dynamic poroelasticity problems.
    ...
    shearWaveSpeed.meta["tip"] = (
        "Shear wave speed in boundary value problem (controls time scale)."
    )
    ...
    def __init__(self, name="dynamicporoelasticity"):
        """
        Constructor.
        """
    ...
    def _configure(self):
        ...
        ElasticityScales.setDynamicPoroelasticity(
            ...
            velocityScale=self.inventory.shearWaveSpeed,
...
def normalizer():
    """
    Factory associated with DynamicPoroelasticity.
    """
    return DynamicPoroelasticity()
